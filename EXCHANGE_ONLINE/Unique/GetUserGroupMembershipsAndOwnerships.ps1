#EXPORT END USER GROUP MEMBERSHIPS AND OWNERSHIPS -- Update the id.txt file with the respective end user's primaryemailaddress -- may require the AzureConnectModule to be installed###
